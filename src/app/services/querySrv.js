...
function (angular, _, config, kbn) {
  ...
  module.service('querySrv', function(dashboard, ejsResource, filterSrv, esVersion, $q) {
    ...
    // ];
    this.colors = [
      "#0257bc", "#a2e481", "#25b960", "#012337", "#82b8e3", "#cc074c", "#13a37a",
      "#024ea7", "#90ca72", "#21a556", "#011f31", "#73a3ca", "#b60644", "#11916c",
      "#014492", "#7eb164", "#1d904b", "#011b2b", "#658fb0", "#9f063b", "#0f7f5e",
      "#013a7d", "#6c9856", "#197c40", "#011725", "#567a97", "#880533", "#0d6d51",
      "#1b71d6", "#bcfd9a", "#3ed37a", "#1a3d50", "#9bd1fc", "#e62166", "#2cbc93",
      "#3581da", "#c3fda5", "#54d889", "#345264", "#a6d6fd", "#e93977", "#44c49f",
      "#4e90df", "#cbfeb1", "#69dd97", "#4d6877", "#b1dbfd", "#eb5288", "#5bcbab",
      "#67a0e3", "#d2febc", "#7fe2a6", "#677d8b", "#bce0fd", "#ee6b99", "#73d3b7"
    ];
